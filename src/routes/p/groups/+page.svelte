  ...
  <header class="mb-8">
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
      <p class="text-sm text-blue-800 dark:text-blue-200">
        <strong>Pro tip:</strong> Use the search bar to quickly find groups or browse by letter to explore the full list.
      </p>
    </div>
  </header>
      ...
      <div class="grid md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-300 text-sm">
            Browse our extensive list of hentai scanlation groups, organized alphabetically for easy navigation.
          </p>
        </div>
        <div>
          <h3 class="font-semibold mb-2 text-pink-600 dark:text-pink-400">Group Profiles</h3>
          <p class="text-gray-600 dark:text-gray-300 text-sm">
            Each group profile includes detailed information about their releases, members, and contributions to hentai.
          </p>
        </div>
      </div>
      <p class="text-gray-600 dark:text-gray-300 mb-4">
        Our group database helps you find and explore your favorite hentai scanlation teams. 
        Use the search feature or browse by letter to discover new groups and their releases.
      </p>
